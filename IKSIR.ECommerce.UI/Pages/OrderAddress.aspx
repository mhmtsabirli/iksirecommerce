...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:radajaxmanager id="RadAjaxManager1" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="pnlAddresses">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="pnlAddresses" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
    ...
    <asp:Panel runat="server" ID="pnlAddresses">
            ...
            <table width="775px" cellpadding="0" cellspacing="0" style="padding-left: 40px;">
                ...
                <tr>
                    <td colspan="2" align="center">
                        <asp:ImageButton runat="server" ID="imgbtnBack" ImageUrl="/images/sepet_end_iptal.jpg"
                            AlternateText="Geri" OnClick="imgbtnBack_Click" />
