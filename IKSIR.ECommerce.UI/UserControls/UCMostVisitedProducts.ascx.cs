...
{
    public partial class UCMostVisitedProducts : System.Web.UI.UserControl
    {
        ...
        private void GetItems()
        {
            ...
            ModuleProduct itemModuleProduct = new ModuleProduct() { Module = new Model.CommonModel.Module() { Id = 2 } };
