...
<div class="header" id="div_header">
    ...
    <div class="logo">
        <a href="../Pages/Default.aspx">
            <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="211" height="71" id="logo" align="middle">
                ...
                <!--[if !IE]>-->
                <object type="application/x-shockwave-flash" data="../images/logo.swf" width="211" height="71">
                    <param name="movie" value="../images/logo.swf" />
                    <param name="quality" value="high" />
                    <param name="bgcolor" value="#ffffff" />
                    <param name="play" value="true" />
