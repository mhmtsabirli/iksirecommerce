<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="posnettds.aspx.cs" Inherits="IKSIR.ECommerce.UI.SecuredPages.posnettds" %>
...
<script language="JavaScript" type="text/javascript" src="../js/posnet.js"></script>
...
<h5 class="style2">Sipariş No :</h5></td>
              ...
              <tr> 
                <td width="107" height="24" colspan="2"> 
                    ...
                    <asp:HiddenField ID="lblvftCode" runat="server" />
