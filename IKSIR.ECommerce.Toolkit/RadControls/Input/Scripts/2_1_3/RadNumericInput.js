...
_2f=NumberFormat.Parse(_2f,this.RejectRegExp,this.NumberFormat.DecimalSeparator,this.NumberFormat.NegativeSign);
}
...
_2f=NumberFormat.Round(_2f,this);
if(isNaN(_2f)){
_2f="";
}
...
var _30=this.GetValue().toString().replace(".",this.NumberFormat.DecimalSeparator);
return _30.replace("-",this.NumberFormat.NegativeSign);
},GetValue:function(){
var _31=parseFloat(this.HiddenElement.value);
if(isNaN(_31)){
_31="";
}
return _31;
...
},SetValidationField:function(_34){
this.validationField.value=_34.toString().replace(".",this.NumberFormat.DecimalSeparator);
},GetValidationField:function(_35){
