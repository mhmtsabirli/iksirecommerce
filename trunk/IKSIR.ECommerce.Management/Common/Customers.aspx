<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterManagement.Master"
    AutoEventWireup="true" CodeBehind="Customers.aspx.cs" Inherits="IKSIR.ECommerce.Management.Common.Customers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <p>
        Kullanıcı hesap biglileri görüntüleme.
    </p>
    <table cellpadding="0" cellspacing="0" border="0">
        <tr>
            <td>
                ...
                <asp:Panel runat="server" ID="Panel1" Visible="false" CssClass="pnlForm">
                    <telerik:RadTabStrip ID="RadTabStrip1" runat="server" Skin="Web20" MultiPageID="RadMultiPage1"
                        SelectedIndex="1" Width="600px">
                        <Tabs>
                            <telerik:RadTab Text="Üye Bilgileri" Selected="true" PageViewID="RadPageView1">
                            </telerik:RadTab>
                            <telerik:RadTab Text="Adresler" PageViewID="RadPageView2">
                            </telerik:RadTab>
                            <telerik:RadTab Text="Siparişler" PageViewID="RadPageView3">
                            </telerik:RadTab>
                            <telerik:RadTab Text="Favori Ürünler" PageViewID="RadPageView4">
                            </telerik:RadTab>
                                                                    ...
                                                                    <asp:GridView runat="server" ID="gvList" AutoGenerateColumns="False" CellPadding="4"
                                                                        ...
                                                                        <Columns>
                                                                            <asp:TemplateField ShowHeader="False">
                                                                                <ItemTemplate>
                                                                                    <asp:LinkButton ID="lbtnEdit" runat="server" OnClick="lbtnEdit_Click" CommandArgument='<%# Eval("Id")%>'>[Incele]</asp:LinkButton>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                            ...
                                            <asp:Repeater runat="server" ID="rptUserFavoriteProducts">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td valign="top">
                                                            <h2>
                                                                <a href='<%# String.Format("http://www.banyom.com.tr/Pages/ProductDetails.aspx?pid={0}", Eval("Product.Id"))%>'
                                                                    target="_blank">
                ...
                <asp:Panel runat="server" ID="pnlFilter" Visible="true">
                    <table>
                        ...
                        <tr>
                            <td rowspan="4">
                                <asp:Button runat="server" ID="btnUserFilter" Text="Filtrele" OnClick="btnUserFilter_Click" />
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
                ...
                <asp:Panel runat="server" ID="Panel2" Visible="true">
                    <asp:GridView runat="server" ID="gvUserList" AutoGenerateColumns="False" CellPadding="4"
                        GridLines="None" PageSize="15" EnableModelValidation="True" Width="500px" EmptyDataText="Listede gösterilecek kayıt bulunamadı"
                        HeaderStyle-HorizontalAlign="Left" AllowPaging="True" OnPageIndexChanging="gvUserList_PageIndexChanging">
                        <Columns>
                            <asp:TemplateField ShowHeader="False">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnUserEdit" runat="server" OnClick="lbtnUserEdit_Click" CommandArgument='<%# Eval("Id")%>'>[Incele]</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="FirstName" HeaderText="Adı" ApplyFormatInEditMode="false"
                                ReadOnly="true" SortExpression="Title" />
                            <asp:BoundField DataField="LastName" HeaderText="SoyAdı" ApplyFormatInEditMode="false"
                                ReadOnly="true" SortExpression="FirstName" />
