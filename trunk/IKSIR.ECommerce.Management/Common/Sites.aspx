<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterManagement.Master"
    AutoEventWireup="true" CodeBehind="Sites.aspx.cs" Inherits="IKSIR.ECommerce.Management.Common.Sites"
    %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="server">
    <h2>
        Site Tanımları</h2>
    <p>
        Sistemdeki Sitelerin Tanımlandığı Ekran
    </p>
    <table id="tblMngForm">
        <tr>
            <td align="left">
                ...
                <asp:Panel runat="server" ID="pnlForm" Visible="false" CssClass="pnlForm">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" Width="100%"  MaxLength="50" ID="txtSiteName"></asp:TextBox>
                            </td>
                            <td>
                                <asp:RequiredFieldValidator runat="server" ID="rfv1" ControlToValidate="txtSiteName"
                                    ValidationGroup="VGForm" SetFocusOnError="true" ErrorMessage="Site Adı Girmelisiniz"
                ...
                <asp:Panel runat="server" ID="pnlFilter" Visible="true">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtFilterSiteName"></asp:TextBox>
                            </td>
                            <td>
