...
namespace IKSIR.ECommerce.Infrastructure.DataLayer.SiteDataLayer
{
    public class SiteCategoryData
    {
        ...
        public static SiteCategory GetById(int Id)
        {
            var returnValue = new SiteCategory();
            List<SqlParameter> parameters = new List<SqlParameter>();
            parameters.Add(new SqlParameter("@SiteId", 0));
            parameters.Add(new SqlParameter("@CategoryId", 0));
        ...
        public static int Update(SiteCategory item)
        {
            var returnValue = 1;
            List<SqlParameter> parameters = new List<SqlParameter>();
            parameters.Add(new SqlParameter("@SiteId", item.Site.Id));
            parameters.Add(new SqlParameter("@Id", item.Id));
            parameters.Add(new SqlParameter("@CategoryId", item.ProductCategory.Id));
        ...
        public static List<SiteCategory> GetSiteCategoryList()
        {
            List<SiteCategory> itemSiteCategoryList = null;
