<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/UIMasterPage.Master"
    AutoEventWireup="true" CodeBehind="SearchResult.aspx.cs" Inherits="IKSIR.ECommerce.UI.Pages.SearchResult" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1>
        Arama Sonuçları</h1>
    <i>Aradığınız kelimeyle ilgili sonuçlar aşağıda listelenmektedir. Aradığınız kelime:
        <asp:Label runat="server" ID="lblSearchKey"></asp:Label><br/><br/>
    </i>
    <asp:Label runat="server" ID="lblNoResult" Text="<br/><br/>Aradığınız kelimeyi içeren ürün bulunmamaktadır."
