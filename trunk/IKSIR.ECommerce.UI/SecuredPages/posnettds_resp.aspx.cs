    ...
    public partial class posnettds_resp : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.amount.Text = posnetOOSTDSObj.GetAmount().Substring(0, posnetOOSTDSObj.GetAmount().Length - 2) + "," + posnetOOSTDSObj.GetAmount().Substring(posnetOOSTDSObj.GetAmount().Length - 2, 2);
