<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterManagement.Master"
    AutoEventWireup="true" CodeBehind="StaticPages.aspx.cs" Inherits="IKSIR.ECommerce.Management.Common.StaticPages"
     %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="server">
    <h2>
        Statik Sayfalar</h2>
    <p>
        Hakkımızda, Kurumsal, Sık Sorulan Sorular gibi statik sayfaların içeriklerinin düzenlemeleri
                ...
                <asp:Panel runat="server" ID="pnlForm" Visible="false" CssClass="pnlForm">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtTitle" MaxLength="250" Width="100%"></asp:TextBox>
                            </td>
                            <td>
